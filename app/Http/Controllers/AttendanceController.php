...
class AttendanceController extends Controller
{
    ...
    public function create($priceId, Request $request)
    {
        ...
        // return $student;
        return view('attendance.form', compact('title', 'data', 'student', 'pointCategories', 'day', 'agenda'));
    }
