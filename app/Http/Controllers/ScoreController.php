    ...
    public function index(Request $request)
    {
        try {
            ...
            $class = DB::select("SELECT DISTINCT priceid,day1,day2,course_time,id_teacher,price.level,price.program,day_1.day day_one,day_2.day day_two,teacher.name teacher_name,
             student.id_teacher as teacher_id, attendance_details.attendance_id as attendance_id,  student.day1 as d1, student.day2 as d2  from student
             ...
             join attendance_details on student.id = attendance_details.student_id
