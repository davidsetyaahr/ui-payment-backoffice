    ...
    <div class="content">
                ...
                <div class="">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li class="nav-item text-white">
                            <a href="#" class="text-white">Reedem Items</a>
                        </li>
                        <li class="separator text-white">
                            <i class="flaticon-right-arrow text-white"></i>
                        </li>
        ...
        <div class="page-inner mt--5">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form
                        action="{{ $data->type == 'create' ? route('reedemItems.store') : route('reedemItems.update', $data->id) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="email2">Item</label>
                                            <input type="text" class="form-control @error('item') is-invalid @enderror"
                                                value="{{ $data->item }}" name="item" placeholder="item">
                                            @error('item')
